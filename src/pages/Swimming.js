...
const Swimming = () => {
  return (
    <div className="swimming">
      ...
      <div className="wrestling1">
        <div className="swimming1">SWIMMING</div>
      </div>
      <div className="locker-181">Locker 18</div>
      <div className="equipments3">Equipments</div>
      <div className="swimming-pool">SWIMMING POOL</div>
      <div className="available-number-of">Available Number of goggles</div>
      <div className="available-number-of1">Available Number of KickboardS</div>
      <div className="available-number-of2">Available Number of Pull buoys</div>
