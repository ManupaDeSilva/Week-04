...
const Wrestling = () => {
  return (
    <div className="wrestling5">
      ...
      <div className="wrestling6">
        <div className="wrestling7">WRESTLING</div>
      </div>
      ...
      <div className="available-number-of9">Available Number of headgears</div>
