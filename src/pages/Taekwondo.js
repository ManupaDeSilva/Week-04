...
const Taekwondo = () => {
  return (
    <div className="taekwondo">
      ...
      <div className="wrestling3">
        <div className="taekwondo1">TAEKWONDO</div>
      </div>
      <div className="locker-182">Locker 18</div>
      <div className="equipments7">Equipments</div>
      <div className="boxing-mat">Boxing Mat</div>
      <div className="available-number-of4">Available Number of Chest pads</div>
      <div className="available-number-of5">Available Number of headgears</div>
