...
const Elle = () => {
  return (
    <div className="elle">
      ...
      <div className="elle-wrapper">
        <div className="elle1">ELLE</div>
      </div>
      <div className="locker-07">Locker 07</div>
      <div className="equipments15">Equipments</div>
      <div className="court2">Court</div>
      <div className="available-number-of11">Available Number of balls</div>
      <div className="available-number-of12">Available Number of bats</div>
      ...
      <div className="courttimeslots11">
        <div className="div11">{`Data Not Available Yet `}</div>
      </div>
