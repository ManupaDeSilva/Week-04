...
const Kickboxing = () => {
  return (
    <div className="kickboxing">
      ...
      <div className="available-number-of6">Available Number of Gloves</div>
      <div className="available-number-of7">Available Number of Headgears</div>
      <div className="available-number-of8">Available Number of Heavy Bags</div>
